...
<head>
	...
	.col-md-6{
		margin: auto;
		position: absolute;
		top: 125;left: 0; bottom: 0; right: 0;
	}
	
	.material-button-anim{
		margin: auto;
		position: absolute;
		top:250;left:500; bottom: 0; right:0;
	}
...
<div id="Layer1" style="position:absolute; width:100%; height:100%; left:0px; top:0px;">
	...
	<form method="get" name="form" action="BookSearch.action">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h2 align="center">作者查询</h2>
						<div id="custom-search-input">
						<div class="input-group col-md-12">
						<input type="text" name="AuthorName" class="form-control input-lg" placeholder="例如：钱钟书" />
      ...
      <div class="col-md-4 col-md-offset-4">
        <div class="material-button-anim">
          <ul class="list-inline" id="options">
            <li class="option">
            <s:url var="url" value="ShowAllBook.action">
            </s:url>
            <s:a href="%{url}">
              <button class="material-button option1" type="button">
                <span class="fa fa-shelf" aria-hidden="true">所有图书</span>
              </button>
            </s:a>
            </li>
            <li class="option">
